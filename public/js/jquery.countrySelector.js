(function ($) {
    ...
    var methods = {
        init: function (options) {
            return this.each(function () {
                var _$input = $(this).hide().attr("autocomplete", "off"),
                    _codeMode = _$input.data("code-mode"),
                    _$selector = $("<div class=\"cs-selector\" tabindex=\"0\"><span class=\"cs-flag-selected cs-flag XXX\"></span><span class=\"cs-name-selected\"></span><span class=\"cs-arrow\"></span></div>")
                        .insertAfter(_$input),
                ...
                function setValue(code) {
                    _$list.children("li").each(function () {
                        ...
                        switch (_codeMode) {
                            case "numeric":
                                code2 = country[NUMERIC_CODE];
                                break;
                            case "alpha2":
                                code2 = country[ALPHA2_CODE];
                                break;
                            default:
                                code2 = country[ALPHA3_CODE];
                                break;
                        }
    ...
    $("input[data-role=country-selector]").countrySelector();
